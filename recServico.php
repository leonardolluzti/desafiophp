...
<html lang="pt-BR">
  ...
  <body class="w3-responsive">
	...
	<section class="w3-container">
        ...
        $sql = pg_query($connection, "INSERT INTO tb_convenio_servico (codigo, convenio, servico) VALUES ('$codigo', '$convenio', '$servico')");
        if ($sql==true){echo ("<div class='w3-panel w3-green'><b>Serviço Inserido com Sucesso!</b></div>");}
        else{echo ("<div class='w3-panel w3-red'><b>Serviço Não Inserido!</b></div>");}            
        pg_close($connection);
        ?>
