...
<html lang="pt-BR">
  <head>
    ...
    <meta name="date" content="2024-03-22T21:33:01-0300" />
  ...
  <body class="w3-responsive">
	...
	<section class="w3-container">
        ...
        <p>     
            Seja bem vindo!
			<br><br>
			Author: Leonardo Lopes da Luz.<br>
			Esse sistema foi feito em PHP 8.1.2.<br>
			Utilizando o Banco de dados PostgreSQL 14.11.<br>
			Servidor Web Apache 2.4.<br>
			Editor Visual Studio Code 1.87.2.<br>
