...
<html lang="pt-BR">
  ...
  <body class="w3-responsive">
	...
	<section class="w3-container">
        ...
        $sql = pg_query($connection, "INSERT INTO tb_banco (codigo, nome) VALUES ('$codigo', '$nome')");
        if ($sql==true){echo ("<div class='w3-panel w3-green'><b>Banco Inserido com Sucesso!</b></div>");}
        else{echo ("<div class='w3-panel w3-red'><b>Banco Não Inserido!</b></div>");}            
        pg_close($connection);
        ?>
